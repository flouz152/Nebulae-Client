package beame.components.baritone.api.selection;

import beame.components.baritone.api.utils.BetterBlockPos;
import net.minecraft.util.Direction;

/**
 * The selection manager handles beame.setting Baritone's selections. You can set the selection here, as well as retrieving
 * the current selection.
 */
public interface ISelectionManager {
// leaked by itskekoff; discord.gg/sk3d y8Sk5fo4
