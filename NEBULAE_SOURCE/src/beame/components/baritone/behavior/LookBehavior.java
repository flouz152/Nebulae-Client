...
import beame.components.baritone.api.behavior.look.IAimProcessor;
import beame.components.baritone.api.behavior.look.ITickableAimProcessor;

import beame.components.baritone.api.event.events.*;
import beame.components.baritone.api.utils.IPlayerContext;
import beame.components.baritone.api.utils.Rotation;
import beame.components.baritone.behavior.look.ForkableRandom;
import net.minecraft.network.play.client.CPlayerPacket;

import java.util.Optional;

public final class LookBehavior extends Behavior implements ILookBehavior {
// leaked by itskekoff; discord.gg/sk3d 0TLbqnAi
    /**
    ...
    public void onTick(TickEventBaritone event) {
        if (event.getType() == TickEventBaritone.Type.IN) {
            this.processor.tick();
        }
    }
    ...
    private static class Target {
        ...
        enum Mode {
            ...
            static Mode resolve(boolean blockInteract) {
                ...
                // whatever the player is mousing over visually. Let's just settle for beame.setting it silently.
