package beame.components.baritone.command.argument;
...
import beame.components.baritone.api.command.datatypes.IDatatype;
import beame.components.baritone.api.command.datatypes.IDatatypeContext;
import beame.components.baritone.api.command.datatypes.IDatatypeFor;
import beame.components.baritone.api.command.datatypes.IDatatypePost;
...
import beame.components.baritone.api.command.exception.CommandNotEnoughArgumentsException;
import beame.components.baritone.api.command.exception.CommandTooManyArgumentsException;
...
// leaked by itskekoff; discord.gg/sk3d 3GzOrm6E
