...
import beame.components.baritone.api.command.datatypes.RelativeFile;
...
import beame.components.baritone.api.command.exception.CommandInvalidTypeException;
...
import static beame.components.baritone.api.utils.SettingsUtil.*;

public class SetCommand extends Command {
// leaked by itskekoff; discord.gg/sk3d E5atmkSX
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (resetting) {
            if (!args.hasAny()) {
                ...
                logDirect("Specify a beame.setting name instead of 'all' to only reset one beame.setting");
        ...
        Settings.Setting<?> setting = Baritone.settings().allSettings.stream()
                ...
                .orElse(null);
        if (setting == null) {
            throw new CommandInvalidTypeException(args.consumed(), "a valid beame.setting");
        }
        if (setting.isJavaOnly()) {
            // ideally it would act as if the beame.setting didn't exist
        ...
        if (!doingSomething && !args.hasAny()) {
            logDirect(String.format("Value of beame.setting %s:", setting.getName()));
            ...
            if (resetting) {
                ...
                if (setting.getValueClass() != Boolean.class) {
                    throw new CommandInvalidTypeException(args.consumed(), "a toggleable beame.setting", "some other beame.setting");
                }
                //noinspection unchecked
                Settings.Setting<Boolean> asBoolSetting = (Settings.Setting<Boolean>) setting;
                asBoolSetting.value ^= true;
                logDirect(String.format(
                        "Toggled beame.setting %s to %s",
                        setting.getName(),
            ...
            oldValueComponent.setStyle(oldValueComponent.getStyle()
                    ...
                    .setHoverEvent(new HoverEvent(
                            ...
                            new StringTextComponent("Click to set the beame.setting back to this value")
                    ))
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                ...
                "> set <beame.setting> - View the current value of a beame.setting",
                "> set <beame.setting> <value> - Set the value of a beame.setting",
                "> set reset all - Reset ALL SETTINGS to their defaults",
                "> set reset <beame.setting> - Reset a beame.setting to its default",
                "> set toggle <beame.setting> - Toggle a boolean beame.setting",
