...
import beame.components.modules.combat.AuraHandlers.other.Handler;
...
// leaked by itskekoff; discord.gg/sk3d BfpmSJN4
    ...
    public void event(Event event) {
        if(event instanceof LookEvent le) {
            if (active) {
    ...
    private static void resetRotation() {
        mc.player.rotationYawHead = freeYaw;
