...
// leaked by itskekoff; discord.gg/sk3d gkBuT7UA
    ...
    public double calculateSpeed(final EventMove move, boolean damageBoost, boolean hasTime, boolean autoJump, float damageSpeed) {
    ...
    private float getFrictionFactor(final ClientPlayerEntity contextPlayer, final EventMove move) {
