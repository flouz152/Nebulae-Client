...
/**
 * Given a binary image, this filter performs binary dilation, beame.setting all added pixels to the given 'new' color.
 */
public class DilateFilter extends BinaryFilter {
// leaked by itskekoff; discord.gg/sk3d m5ItCTcM
