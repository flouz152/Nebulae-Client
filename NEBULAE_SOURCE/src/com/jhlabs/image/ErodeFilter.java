...
/**
 * Given a binary image, this filter performs binary erosion, beame.setting all removed pixels to the given 'new' color.
 */
public class ErodeFilter extends BinaryFilter {
// leaked by itskekoff; discord.gg/sk3d nKMrO92V
