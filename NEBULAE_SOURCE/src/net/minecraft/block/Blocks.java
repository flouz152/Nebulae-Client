...
public class Blocks
{
// leaked by itskekoff; discord.gg/sk3d xWzjtAwb
    ...
    public static final Block POPPY = register("poppy", new FlowerBlock(Effects.Essence_VISION, 5, AbstractBlock.Properties.create(Material.PLANTS).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)));
