...
import beame.components.baritone.api.event.events.ChunkEvent;
...
{
// leaked by itskekoff; discord.gg/sk3d AiOI4rQ9
    ...
    public void handleSpawnPlayer(SSpawnPlayerPacket packetIn)
    {
        ...
        if (remoteclientplayerentity != null) {
    ...
    public void handleEntityStatus(SEntityStatusPacket packetIn)
    {
        ...
        if (entity != null)
        {
            if (packetIn.getOpCode() == 21)
            {
                ...
                TotemPopEvent event = new TotemPopEvent();
                ...
                Particles.onEntityStatus((byte)35, entity);
     ...
     * for beame.setting the instrument (including audiovisual feedback) and in BlockContainer to set the number of players
