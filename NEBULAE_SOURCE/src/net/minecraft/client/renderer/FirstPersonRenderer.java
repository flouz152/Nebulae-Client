...
{
// leaked by itskekoff; discord.gg/sk3d FAeWSftN
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(handIn))
        {
            ...
            else
            {
                ...
                else if (player.isSpinAttacking())
                {
                    ...
                    if(!swingAnimations.isState()) matrixStackIn.translate((double)((float)l * f6), (double)f7, (double)f10);
                    ...
                    if (swingAnimations.isState() && handside == HandSide.RIGHT) {
                        swingAnimations.animationProcess(matrixStackIn, swingProgress, () -> {
                            this.transformFirstPerson(matrixStackIn, handside, swingProgress);
                        });
                    } else {
                        this.transformFirstPerson(matrixStackIn, handside, swingProgress);
