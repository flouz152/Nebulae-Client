...
{
// leaked by itskekoff; discord.gg/sk3d 7S5EGa1V
    ...
    public void updateLightmap(float partialTicks)
    {
        if (this.needsUpdate)
        {
            ...
            if (clientworld != null)
            {
                ...
                {
                    boolean flag = this.client.player.isPotionActive(Effects.Essence_VISION) || this.client.player.isPotionActive(Effects.CONDUIT_POWER);
                ...
                if (this.client.player.isPotionActive(Effects.Essence_VISION))
                {
                    f2 = GameRenderer.getEssenceVisionBrightness(this.client.player, partialTicks);
                }
