...
import beame.components.modules.movement.GuiMove;
...
{
// leaked by itskekoff; discord.gg/sk3d iyJid9Hf
    ...
    public static void unPressAllMoveKeys() {
        for (KeyBinding keybinding :  GuiMove.pressedKeys) keybinding.unpressKey();
    }
