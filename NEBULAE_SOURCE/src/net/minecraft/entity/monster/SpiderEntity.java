...
{
// leaked by itskekoff; discord.gg/sk3d Z7e6OuRB
    ...
    /**
     * Updates the WatchableObject (Byte) created in entityInit(), beame.setting it to 0x01 if par1 is true or 0x00 if it is
     * false.
     */
