...
import beame.components.baritone.api.event.events.PacketEvent;
import beame.components.baritone.api.event.events.type.EventState;
import beame.proxy.Proxy;
import beame.proxy.ProxyServer;
...
{
// leaked by itskekoff; discord.gg/sk3d hxrRct9z
    ...
    {
        EventPacket e = new EventPacket(packetIn, EventPacket.PacketType.SEND);
        EventManager.call(e);
