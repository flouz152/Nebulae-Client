...
{
// leaked by itskekoff; discord.gg/sk3d UIwtr27h
    ...
    public List<AddPlayerData> getPlayerAdditionEntries() {
        return this.getAction().equals(SPlayerListItemPacket.Action.ADD_PLAYER) ? this.players : List.of();
    }
