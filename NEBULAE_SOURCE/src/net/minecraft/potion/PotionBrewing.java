...
{
// leaked by itskekoff; discord.gg/sk3d LuYebmv2
    ...
    public static void init()
    {
        ...
        addMix(Potions.AWKWARD, Items.GOLDEN_CARROT, Potions.Essence_VISION);
        addMix(Potions.Essence_VISION, Items.REDSTONE, Potions.LONG_Essence_VISION);
        addMix(Potions.Essence_VISION, Items.FERMENTED_SPIDER_EYE, Potions.INVISIBILITY);
        addMix(Potions.LONG_Essence_VISION, Items.FERMENTED_SPIDER_EYE, Potions.LONG_INVISIBILITY);
