...
{
// leaked by itskekoff; discord.gg/sk3d Y6XndkZM
    ...
    public static final Potion Essence_VISION = register("Essence_vision", new Potion(new EffectInstance(Effects.Essence_VISION, 3600)));
    public static final Potion LONG_Essence_VISION = register("long_Essence_vision", new Potion("Essence_vision", new EffectInstance(Effects.Essence_VISION, 9600)));
