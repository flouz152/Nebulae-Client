...
{
// leaked by itskekoff; discord.gg/sk3d 7bLKeNSU
    ...
    private void createEULAFile()
    {
        if (!SharedConstants.developmentMode)
        {
            try (OutputStream outputstream = Files.newOutputStream(this.eulaFile))
            {
                ...
                properties.store(outputstream, "By changing the beame.setting below to TRUE you are indicating your agreement to our EULA (https://account.mojang.com/documents/minecraft_eula).");
            }
            catch (Exception exception)
            {
