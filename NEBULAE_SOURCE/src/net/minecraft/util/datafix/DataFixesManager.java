...
{
// leaked by itskekoff; discord.gg/sk3d gG5aqRiN
    ...
    private static void addFixers(DataFixerBuilder builder)
    {
        ...
        builder.addFixer(new SwapHandsFix(schema123, false, "Rename swapHands beame.setting", "key_key.swapHands", "key_key.swapOffhand"));
