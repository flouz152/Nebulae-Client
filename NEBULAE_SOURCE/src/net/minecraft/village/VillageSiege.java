...
{
// leaked by itskekoff; discord.gg/sk3d 5HMsUFKr
    ...
    public int func_230253_a_(ServerWorld p_230253_1_, boolean p_230253_2_, boolean p_230253_3_)
    {
        if (!p_230253_1_.isDaytime() && p_230253_2_)
        {
            ...
            if ((double)f == 0.5D)
            {
                this.siegeState = p_230253_1_.rand.nextInt(10) == 0 ? VillageSiege.State.SIEGE_TOEssence : VillageSiege.State.SIEGE_DONE;
            }
