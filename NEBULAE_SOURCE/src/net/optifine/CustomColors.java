...
{
// leaked by itskekoff; discord.gg/sk3d XF3BVJFL
    ...
    public static boolean updateLightmap(ClientWorld world, float torchFlickerX, NativeImage lmColors, boolean Essencevision, float partialTicks)
    {
        if (world == null)
        {
            return false;
        ...
        else
        {
            ...
            if (j >= 0 && j < lightMapPacks.length)
            {
                ...
                return lightmappack == null ? false : lightmappack.updateLightmap(world, torchFlickerX, lmColors, Essencevision, partialTicks);
            }
            else
            {
                return false;
