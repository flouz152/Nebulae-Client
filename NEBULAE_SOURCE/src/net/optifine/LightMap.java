...
{
// leaked by itskekoff; discord.gg/sk3d dVuF2RFL
    ...
    public boolean updateLightmap(ClientWorld world, float torchFlickerX, int[] lmColors, boolean Essencevision)
    {
