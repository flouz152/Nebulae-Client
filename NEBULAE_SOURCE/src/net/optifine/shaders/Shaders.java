...
{
// leaked by itskekoff; discord.gg/sk3d PN86CoR4
    static Minecraft mc;
    ...
    static float EssenceVision = 0.0F;
    ...
    public static ShaderUniform1f uniform_EssenceVision = shaderUniforms.make1f("EssenceVision");
    ...
    private static void setProgramUniforms(ProgramStage programStage)
    {
        ...
        setProgramUniform1f(uniform_EssenceVision, EssenceVision);
        ...
        if (clientworld != null)
        {
            ...
            if (entity != null)
            {
                ...
                if (entity instanceof LivingEntity)
                {
                    ...
                    if (livingentity.isPotionActive(Effects.Essence_VISION))
                    {
                        GameRenderer gamerenderer = entityRenderer;
                        EssenceVision = GameRenderer.getEssenceVisionBrightness(livingentity, partialTicks);
                    }
