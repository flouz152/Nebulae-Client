...
{
// leaked by itskekoff; discord.gg/sk3d 5uuQd66C
    ...
    {
        activeRenderInfo.update(mc.world, (Entity)(mc.getRenderViewEntity() == null ? mc.player : mc.getRenderViewEntity()), !mc.gameSettings.getPointOfView().firstPerson(), mc.gameSettings.getPointOfView().thirdPersonFront(), partialTicks);
    }
