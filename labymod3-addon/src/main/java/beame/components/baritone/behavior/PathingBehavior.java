...
import beame.components.baritone.api.utils.PathCalculationResult;
import beame.components.baritone.api.utils.interfaces.IGoalRenderPos;
import beame.components.baritone.pathing.calc.AStarPathFinder;
import beame.components.baritone.pathing.calc.AbstractNodeCostSearch;
...
import beame.components.baritone.pathing.path.PathExecutor;
import beame.components.baritone.utils.PathRenderer;
import beame.components.baritone.utils.PathingCommandContext;
import beame.components.baritone.utils.pathing.Favoring;
...
// leaked by itskekoff; discord.gg/sk3d x3VeqN9c
    ...
    @Override
    public void onTick(TickEventBaritone event) {
        dispatchEvents();
        if (event.getType() == TickEventBaritone.Type.OUT) {
