...
import beame.components.baritone.api.command.datatypes.ForAxis;
import beame.components.baritone.api.command.datatypes.ForBlockOptionalMeta;
import beame.components.baritone.api.command.datatypes.ForDirection;
import beame.components.baritone.api.command.datatypes.RelativeBlockPos;
...
import beame.components.baritone.api.schematic.*;

import beame.components.baritone.api.schematic.*;
import beame.components.baritone.api.schematic.mask.shape.CylinderMask;
import beame.components.baritone.api.schematic.mask.shape.SphereMask;
...
import beame.components.baritone.api.utils.BlockOptionalMetaLookup;
import beame.components.baritone.utils.BlockStateInterface;
import beame.components.baritone.utils.IRenderer;
import beame.components.baritone.utils.schematic.StaticSchematic;
...
// leaked by itskekoff; discord.gg/sk3d Ci8LRxgW
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                ...
                "> sel undo/u - Undo the last action (beame.setting positions, creating selections, etc.)",
