package beame.components.baritone.pathing.movement;
...
import beame.components.baritone.api.pathing.movement.ActionCosts;
import beame.components.baritone.api.pathing.movement.MovementStatus;

import beame.components.baritone.api.utils.*;

import beame.components.baritone.api.utils.*;
import beame.components.baritone.api.utils.input.Input;
import beame.components.baritone.pathing.movement.MovementState.MovementTarget;
import beame.components.baritone.pathing.precompute.Ternary;
import beame.components.baritone.utils.BlockStateInterface;
import beame.components.baritone.utils.ToolSet;
...
import static beame.components.baritone.pathing.movement.Movement.HORIZONTALS_BUT_ALSO_DOWN_____SO_EVERY_DIRECTION_EXCEPT_UP;
import static beame.components.baritone.pathing.precompute.Ternary.*;
...
// leaked by itskekoff; discord.gg/sk3d BVcPimRF
    ...
    static boolean avoidAdjacentBreaking(BlockStateInterface bsi, int x, int y, int z, boolean directlyAbove) {
        ...
        if (!directlyAbove // it is fine to mine a block that has a falling block directly above, this (the cost of breaking the stacked fallings) is included in cost calculations
                ...
                && Baritone.settings().avoidUpdatingFallingBlocks.value // and if the beame.setting is enabled
