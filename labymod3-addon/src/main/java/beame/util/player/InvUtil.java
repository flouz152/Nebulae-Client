...
// leaked by itskekoff; discord.gg/sk3d rYIRfxec
    ...
    public static void moveInventoryItemStackToOffHand(int slot) {
        ...
        boolean offhandNotStacked = prevOffHandStack.getCount() == 1 || prevOffHandStack.getItem() == Items.AIR;
        ...
        switch (invAction) {
            case HOTBAR_SWAP:
                ...
                break;
            case TRIPLE_CLICK:
                boolean sendRC = getStackFromSlot(slot).getCount() == 1 && offhandNotStacked;
