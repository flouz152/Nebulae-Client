package beame.components.baritone.api.utils.gui;
...
// leaked by itskekoff; discord.gg/sk3d g3bdTFuA
    ...
    public static void addOrUpdate(ITextComponent title, ITextComponent subtitle) {
        addOrUpdate(Minecraft.getInstance().getToastGui(), title, subtitle, BaritoneAPI.getSettings().toastTimer.value);
    }
}
