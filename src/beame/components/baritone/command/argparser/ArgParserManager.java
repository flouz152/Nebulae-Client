package beame.components.baritone.command.argparser;
...
import beame.components.baritone.api.command.exception.CommandNoParserForTypeException;
import beame.components.baritone.api.command.registry.Registry;

public enum ArgParserManager implements IArgParserManager {
// leaked by itskekoff; discord.gg/sk3d 1m6chwbR
    INSTANCE;
