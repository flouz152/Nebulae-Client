...
// leaked by itskekoff; discord.gg/sk3d Z0W4naod
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button)
    {
        ...
        else
        {
            ...
            if(Objects.equals(text, start_text)){
                setText("");
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                ClientHandler.drawRound(x, y, width, height, 3, ColorUtils.getColor(20, 20, 20, this.isFocused() ? 80 : 50));
            }
            ...
            j1 = l + Fonts.SF_BOLD.get(16).drawString(text, l, i1 + 2, -1);
            ...
            {
                Fonts.SF_BOLD.get(16).drawString(this.suggestion, (float)(k1 - 1), (float)i1, -1);
            }
            ...
            if (flag1)
            {
                ...
                {
                    Fonts.SF_BOLD.get(16).drawString("_", (float)k1, (float)i1 + 2, -1);
                }
            }
