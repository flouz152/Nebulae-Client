...
{
// leaked by itskekoff; discord.gg/sk3d 2fmZa5rO
     ...
     */
    EventPlace eventPlace = new EventPlace(null, null);

    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
            eventPlace.setBlock(this);
            eventPlace.setPos(pos);
            EventManager.call(eventPlace);
    }
