...
{
// leaked by itskekoff; discord.gg/sk3d NAcc7PS5
    ...
    private void mouseButtonCallback(long handle, int button, int action, int mods)
    {
        if (handle == this.minecraft.getMainWindow().getHandle())
        {
            ...
            if (this.minecraft.loadingGui == null)
            {
                ...
                {
                    final boolean isDropDaun = this.minecraft.currentScreen instanceof DropDownGui;

                    final int guiScale = this.minecraft.gameSettings.guiScale;

                    if (isDropDaun) this.minecraft.getMainWindow().setGuiScale(2);
                    ...
                    if (isDropDaun) this.minecraft.getMainWindow().setGuiScale(guiScale);
                }
            }
        ...
        if (this.isMouseGrabbed() && this.minecraft.isGameFocused())
        {
            ...
            if (this.minecraft.player != null) {
                try {
                    ...
                    // Если возникает ошибка при обработке события, выполним поворот напрямую
                    this.minecraft.player.rotateTowards(d2, d3 * (double) i);
                }
            }
        }
