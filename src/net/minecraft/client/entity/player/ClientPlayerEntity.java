...
import beame.components.baritone.api.event.events.ChatEvent;
...
import events.impl.game.ChatInputEvent;
...
// leaked by itskekoff; discord.gg/sk3d jGAj7qrT
    ...
    public int ticksSinceLastSwing = 0;
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        HitEvent h = new HitEvent(this,source,amount);
        EventManager.call(h);
    ...
    private final EventPostMotion eventPostMotion = new EventPostMotion();
    ...
    private void onUpdateWalkingPlayer() {
        if (!windowClickMemory.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (memory != null && memory.timerWaitAction.hasReached(memory.timeWait)) {
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            EventSlowWalking event = new EventSlowWalking(this.movementInput.moveForward, this.movementInput.moveStrafe);
            EventManager.call(event);
