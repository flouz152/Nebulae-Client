...
{
// leaked by itskekoff; discord.gg/sk3d SKSsnQc7
    ...
    private int colorOutline = field_238628_c_ ;
    private int colorProgress = field_238628_c_ ;
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(!Nebulae.getHandler().unhooked) {
            ...
            Fonts.LOGO.get(size).drawCenteredString("Z", mc.getMainWindow().getScaledWidth() / 2, mc.getMainWindow().getScaledHeight() / 2 - Fonts.LOGO.get(size).getWidth("Z") / 2, -1);
        }
