...
{
// leaked by itskekoff; discord.gg/sk3d bnEHEFvi
    ...
    public void changeNickname() {
        ...
        if (newNick.length() >= 3 && newNick.length() <= 25) {
            String uuid = UUID.randomUUID().toString();
            mc.session = new Session(newNick, uuid, "", "mojang");
        }
    }
    ...
    private void addSingleplayerMultiplayerButtons(int yIn, int rowHeightIn)
    {
        ...
        if(Nebulae.getHandler().unhooked){
            ...
            (usernameButton = this.addButton(new Button(this.width / 2 + 50, yIn + rowHeightIn * 2, 50, 20, ITextComponent.getTextComponentOrEmpty("Login"), (p_lambda$addSingleplayerMultiplayerButtons$7_1_) ->
            {
                this.changeNickname();
            }, button$itooltip))).active = flag;
            usernameField = new TextFieldWidget(mc.fontRenderer, this.width / 2 - 100, yIn + rowHeightIn * 2, 140, 20, usernameField, new StringTextComponent("name"));
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(Nebulae.getHandler().unhooked) {
            ...
            ClientHandler.drawSexyRect(0, 0, mc.getMainWindow().scaledWidth(), mc.getMainWindow().scaledHeight(), 0, true);
