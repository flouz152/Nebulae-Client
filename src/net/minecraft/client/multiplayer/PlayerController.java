...
import events.impl.game.EventDestroyBlock;
import events.impl.player.EventAttack;
import events.impl.player.EventWindowClick;
...
// leaked by itskekoff; discord.gg/sk3d poQCNwOA
    ...
    public void attackEntity(PlayerEntity playerIn, Entity targetEntity) {
        ...
        if (targetEntity.equals(playerIn) || event.isCancel())
            return;
        this.syncCurrentPlayItem();
