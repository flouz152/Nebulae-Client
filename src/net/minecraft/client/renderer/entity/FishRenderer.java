...
{
// leaked by itskekoff; discord.gg/sk3d Cqayt0gd
    ...
    public void render(FishingBobberEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
        ...
        if (playerentity != null)
        {
            ...
            if ((this.renderManager.options == null || this.renderManager.options.getPointOfView().firstPerson()) && playerentity == Minecraft.getInstance().player)
            {
