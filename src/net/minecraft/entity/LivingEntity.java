...
import events.impl.player.EventTravel;
...
// leaked by itskekoff; discord.gg/sk3d rLdj4EwD
    ...
    public TimerUtil lastSwing = new TimerUtil();
    public boolean tryAttack = false;
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            float f1 = (Minecraft.getInstance().player.rotationYawOffset == Integer.MIN_VALUE ? this.rotationYaw : Minecraft.getInstance().player.rotationYawOffset) * ((float) Math.PI / 180F);
    ...
    public void travel(Vector3d travelVector) {
        if (this.isServerWorld() || this.canPassengerSteer()) {
            ...
            if (this.isInWater() && this.func_241208_cS_() && !this.func_230285_a_(fluidstate.getFluid())) {
                ...
                EventTravel travel = new EventTravel(f6, true);
                if (this instanceof ClientPlayerEntity)
